...
import com.mei.zhuang.pms.service.IPmsGiftsService;
import com.mei.zhuang.pms.service.IPmsProductConsultService;
import com.mei.zhuang.pms.service.IPmsProductService;
import com.mei.zhuang.sms.service.*;
import com.mei.zhuang.ums.service.IUmsMemberBlanceLogService;
...
import com.mei.zhuang.util.applet.TemplateData;
import com.mei.zhuang.util.applet.WX_TemplateMsgUtil;
...
public class OmsOrderServiceImpl extends ServiceImpl<OmsOrderMapper, OmsOrder> implements IOmsOrderService {
    ...
    public int payOrder(TbThanks tbThanks) {
        ...
        if (tbOrder.getPid()==null){
            orderService.update(tbOrder,new QueryWrapper<OmsOrder>().eq("pid",tbOrder.getId()));
        }
    ...
    public OmsOrder blancePay(OmsOrder order) {
        ...
        if (order.getPid()==null){
            ...
            neworder.setPayType(AllEnum.OrderPayType.balancePay.code());
            neworder.setPaymentTime(new Date());
            orderService.update(neworder,new QueryWrapper<OmsOrder>().eq("pid",order.getId()));
        }
