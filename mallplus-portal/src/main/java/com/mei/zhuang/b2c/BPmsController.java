...
import com.mei.zhuang.cms.service.ICmsFavoriteService;
import com.mei.zhuang.cms.service.ICmsSubjectCategoryService;
import com.mei.zhuang.cms.service.ICmsSubjectCommentService;
import com.mei.zhuang.cms.service.ICmsSubjectService;
import com.mei.zhuang.enums.AllEnum;
import com.mei.zhuang.enums.ConstansValue;
import com.mei.zhuang.pms.service.*;
import com.mei.zhuang.single.ApiBaseAction;
import com.mei.zhuang.sms.service.ISmsGroupActivityService;
import com.mei.zhuang.sms.service.ISmsGroupService;
import com.mei.zhuang.sms.service.ISmsHomeAdvertiseService;
import com.mei.zhuang.ums.service.IUmsMemberLevelService;
...
public class BPmsController extends ApiBaseAction {
    ...
    @Resource
    private com.mei.zhuang.pms.service.IPmsBrandService IPmsBrandService;
    @Resource
    ...
    public Object pidCategoryList() throws Exception {
        ...
        try {
            if (ValidatorUtils.empty(json)){
                ...
                redisService.expire(Rediskey.categoryAndChilds,3600*5);
            }else{
    ...
    public Object list(@RequestParam(value = "goodsId", required = false, defaultValue = "0") Long goodsId,
        ...
        redisService.expire(Rediskey.goodsConsult+"goods"+goodsId,3600*5);
        return new CommonResult().success(objectMap);
    }
    ...
    public Object categoryAndGoodsList(PmsProductAttributeCategory productCategory) throws Exception {
        ...
        redisService.expire(Rediskey.categoryAndGoodsList,3600*5);
        return new CommonResult().success(productAttributeCategoryList);
    }
