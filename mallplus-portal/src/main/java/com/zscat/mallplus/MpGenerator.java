...
//            "ums_member_task","ums_growth_change_history","ums_integration_change_history","ums_integration_consume_setting"}); // 需要生成的表
        strategy.setInclude(new String[]{"build_repair", "build_type_price", "build_wuye_price", "build_wuye_company", "build_adv", "build_apply_room", "build_notice", "build_group", "build_group_member"});
