...
<script>
    //将qwerty都替换为$
    import {fetchList, delete${className}} from '@/api/${module}/${classname}'
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.qwertyrouter.push(
                        {path: '/${module}/update${className}', query: {id: row.id}})
            },
            handleDelete(index, row) {
                this.qwertyconfirm('是否要删除该类型', '提示', {
            ...
            add${className}() {
                //手动将router,改成$router
                this.qwertyrouter.push({path: '/${module}/add${className}'})
            }
        }
    }
</script>
