...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有商户管理列表")
@ApiOperation("根据条件查询所有商户管理列表")
...
try {
return new CommonResult().success(IAdminDayStaticsService.page(new Page<AdminDayStatics>(pageNum, pageSize), new QueryWrapper<>(entity)));
} catch (Exception e) {
log.error("根据条件查询所有商户管理列表：%s", e.getMessage(), e);
}
return new CommonResult().failed();
}

@SysLog(MODULE = "sys", REMARK = "保存商户管理")
@ApiOperation("保存商户管理")
...
log.error("保存商户管理：%s", e.getMessage(), e);
return new CommonResult().failed(e.getMessage());
}
return new CommonResult().failed();
}

@SysLog(MODULE = "sys", REMARK = "更新商户管理")
@ApiOperation("更新商户管理")
...
log.error("更新商户管理：%s", e.getMessage(), e);
return new CommonResult().failed(e.getMessage());
}
return new CommonResult().failed();
}

@SysLog(MODULE = "sys", REMARK = "删除商户管理")
@ApiOperation("删除商户管理")
@GetMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:adminDayStatics:delete')")
public Object deleteAdminDayStatics(@ApiParam("商户管理id") @PathVariable Long id) {
try {
if (ValidatorUtils.empty(id)) {
return new CommonResult().paramFailed("商户管理id");
}
if (IAdminDayStaticsService.removeById(id)) {
return new CommonResult().success();
}
} catch (Exception e) {
log.error("删除商户管理：%s", e.getMessage(), e);
return new CommonResult().failed(e.getMessage());
}
return new CommonResult().failed();
}

@SysLog(MODULE = "sys", REMARK = "给商户管理分配商户管理")
@ApiOperation("查询商户管理明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:adminDayStatics:read')")
public Object getAdminDayStaticsById(@ApiParam("商户管理id") @PathVariable Long id) {
try {
if (ValidatorUtils.empty(id)) {
return new CommonResult().paramFailed("商户管理id");
}
...
log.error("查询商户管理明细：%s", e.getMessage(), e);
return new CommonResult().failed();
}

}

@ApiOperation(value = "批量删除商户管理")
@RequestMapping(value = "/delete/batch", method = RequestMethod.GET)
@SysLog(MODULE = "sys", REMARK = "批量删除商户管理")
@PreAuthorize("hasAuthority('sys:adminDayStatics:delete')")
