...
public class ShellUtil {
    ...
    public static void main(String[] args) {
        new ShellUtil("172.21.11.178",22,"postgres","postgres")
                .executeCommands(new String[]{
//                    "/usr/pgsql11/bin/psql -h localhost -U postgres -d crm_template < /data/bak/tenant_crm_template_test_20190221.bak",
//                        "cp /data/bak/crm_template.bak /data/bak/tenant_crm_template_test_20190221.bak",
                        "ls /data/bak -lh"
//                        "sed -i \"s/$./test./g\" /data/bak/tenant_crm_template_test_20190221.bak"
//                        "sed -i \"s/public./test./g\" /data/bak/tenant_crm_template_test_20190221.bak"
                });
//        System.out.println(">>>>>>>>>>>>>>>>> all ending");
    }
}
