...
public class ConstansValue {
    public static final List<String> IGNORE_TENANT_TABLES = Lists.newArrayList("sys_admin_log", "sys_web_log", "sys_permission_category", "columns", "tables", "information_schema.columns",
            ...
            "pms_product_category_attribute_relation", "pms_small_navicon_category","bak_category","es_shop_goods_group_map","sys_applet_set", "bak_goods", "bak_brand","oms_order_setting","ums_member", "ums_member_level", "building_user_community", "gen_config");
